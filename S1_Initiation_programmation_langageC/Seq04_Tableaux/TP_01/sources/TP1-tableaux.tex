...
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/moyenne
  \end{lstlisting}
...
\begin{UPSTIManipulation}{Notes — Filtrer au-dessus d'un seuil}
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/filtre_notes
  \end{lstlisting}
\end{UPSTIManipulation}
...
\begin{UPSTIManipulation}{Cinéma — Places libres et taux d'occupation}
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/cinema_occupation
  \end{lstlisting}
\end{UPSTIManipulation}
...
La bandite ; Toxicity ; Basique ; J adore ; La symphonie des nuages
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/playlist_rotation
  \end{lstlisting}
\end{UPSTIManipulation}
...
-> 4 9 2 1
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/playlist_dedupe
  \end{lstlisting}
\end{UPSTIManipulation}
...
\begin{UPSTIManipulation}{Borner le nombre d'invités}
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/stock_clamp
  \end{lstlisting}
\end{UPSTIManipulation}
...
out= 2 5 7 4 1
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/web_moving_avg
  \end{lstlisting}
\end{UPSTIManipulation}
...
swaps= 3
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/tarifs_selection_sort
  \end{lstlisting}
\end{UPSTIManipulation}
...
id= 2 4 6 8, x=5 -> -1
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/catalogue_bsearch
  \end{lstlisting}
\end{UPSTIManipulation}
...
B =
  ...
  \tcblower
  \begin{lstlisting}[language=bash]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp_tableaux/image_seuillage_2D
  \end{lstlisting}
\end{UPSTIManipulation}
