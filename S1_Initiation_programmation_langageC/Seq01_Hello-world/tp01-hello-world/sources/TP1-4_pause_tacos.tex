...
\end{lstlisting}
	...
	\textbf{Checks:}
	\begin{lstlisting}[language=bash,style=console]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp1/4_tacos/niveau1
\end{lstlisting}
...
\end{lstlisting}
	...
	\hrule
	\begin{lstlisting}[language=bash,style=console]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp1/4_tacos/niveau2
\end{lstlisting}
\end{UPSTIcahierDesCharges}
...
\begin{UPSTIcahierDesCharges}{Pause Tacos - Niveau 3 - Réduction}
	...
	\hrule
	\begin{lstlisting}[language=bash,style=console]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp1/4_tacos/niveau3
\end{lstlisting}
\end{UPSTIcahierDesCharges}