...
\begin{UPSTIinfor}{Algorithme de recherche dichotomique}
	...
	4  \textit{Si} la personne se trouve dans la page
	5      Appeler la personne
	6  \textit{Sinon, si} la personne se trouve plus tôt dans l'annuaire (alphabétiquement)
	7      Ouvrir le livre au milieu de la partie gauche
	8      Retourner à l'étape 3
	9  \textit{Sinon, si} la personne se trouve plus tard dans l'annuaire (alphabétiquement)
	10     Ouvrir le livre au milieu de la partie droite
	11     Retourner à l'étape 3
	12 \textit{Sinon}
	13     Quitter \textit{(La personne n'a pas été trouvée dans l'annuaire)}
\end{UPSTIinfor}
