...
\begin{UPSTIexercice}{Supervision d'une ligne de production}
    ...
    \begin{UPSTICahierDesCharges}{1}
        \begin{itemize}
            \item A l'arrêt, le boîtier se contente de l'indiquer, sans effectuer aucun calcul.
            \item En marche, l'opérateur doit connaître le taux de pièces défectueuses parmi les pièces produites, exprimé en pourcentage entier.
    ...
    \UPSTIquestion{Avant d'écrire quoi que ce soit : d'après ce cahier des charges, combien de structures conditionnelles sont nécessaires, et sont-elles imbriquées ou enchaînées ?}
    \UPSTIquestion{Écrire le pseudo-code répondant à ce cahier des charges. Le calcul du taux utilisera une division entière ; on veillera à multiplier par 100 \textbf{avant} de diviser, pour ne pas perdre le résultat dans la troncature.}
