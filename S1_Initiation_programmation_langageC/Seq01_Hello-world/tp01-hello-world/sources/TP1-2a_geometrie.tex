...
check50 IUT-GEII-Annecy/exercices/2026/info1/tp1/2_geometrie/rectangle/niveau1
\end{lstlisting}
...
\begin{UPSTIcahierDesCharges}{Cercle Niveau 1}
	...
	\textbf{Check :}
	\begin{lstlisting}[language=bash,style=console]
check50 IUT-GEII-Annecy/exercices/2026/info1/tp1/2_geometrie/cercle/niveau1
\end{lstlisting}
\end{UPSTIcahierDesCharges}
